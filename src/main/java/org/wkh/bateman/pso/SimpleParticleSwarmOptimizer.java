...
public class SimpleParticleSwarmOptimizer
{
    ...
    private static final double omega = 0.999; // acceleration coefficient (蠅 in Wikipedia's velocity equation)
    ...
    /** <默认构造函数>
     * @param fitness 适应函数
     * @param xmin {minBuy, minSell, 0.0}
     * @param xmax {maxBuy, maxSell, maxStop}
    ...
    public double[] learn()
    {
        ...
        {
            logger
                .info("Generation " + generation + ": best value " + gbestVal + " at coords " + Arrays.toString(gbest));
