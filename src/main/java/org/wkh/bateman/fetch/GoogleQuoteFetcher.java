...
public class GoogleQuoteFetcher extends QuoteFetcher
{
    ...
    {
        String[] lines = dropLines(quoteList, 7);
        ...
        for (String line : lines)
        {
            ...
            Quote quote = new Quote(date, interval, new BigDecimal(parts[4]), new BigDecimal(parts[2]),
                new BigDecimal(parts[3]), new BigDecimal(parts[1]), Integer.parseInt(parts[5]));
